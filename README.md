...
2025/7/17
 ...
 - 完整支持对携带 [mihomo 完整示例配置](https://github.com/MetaCubeX/mihomo/blob/Meta/docs/config.yaml) 中任意 Trojan 节点参数的节点链接进行转换。
 - 新增对 vless-xhttp 节点链接的解析支持。
 - 增加动态版本号机制，下游 fork 仓库构建镜像将会在 /version 中体现对应仓库的所有者，便于用户区分。  
